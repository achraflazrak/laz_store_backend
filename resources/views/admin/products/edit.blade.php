                                ...
                                <form action="{{ route('admin.products.update', $product) }}" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="name_en" placeholder="Name EN*"
                                                value="{{ $product->name_en, old('name_en') }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="name_fr" placeholder="Name FR*"
                                                value="{{$product->name_fr, old('name_fr') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="qty" placeholder="Quantity*" value="{{ $product->qty, old('qty') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="subcategory_id" id="subcategory_id"
                                                ...
                                                <option @if ($subcategory->id === $product->subcategory_id) selected @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="desc_en" cols="30" rows="10" placeholder="Description EN*"
                                                class="form-control summernote @error('desc_en') is-invalid @enderror">{{ $product->desc_en, old('desc_en') }}</textarea>
                                            @error('desc_en')
                                                <span class="invalid-feedback">
                                                    {{ $message }}
                                                </span>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="desc_fr" cols="30" rows="10" placeholder="Description FR*"
                                                class="form-control summernote @error('desc_fr') is-invalid @enderror">{{ $product->desc_fr ,old('desc_fr') }}</textarea>
                                            @error('desc_fr')
                                                <span class="invalid-feedback">
                                                    {{ $message }}
                                                </span>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="tag_fr"
                                                        class="form-control @error('tag_fr') is-invalid @enderror"
                                    ...
                                    <div class="row my-3">
                                        <div class="col-md-6">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="color_en"
                                                        class="form-control @error('color_en') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="color_fr"
                                                        class="form-control @error('color_fr') is-invalid @enderror"
                                    ...
                                    <div class="row my-3">
                                        <div class="col-md-6">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="size_en"
                                                        class="form-control @error('size_en') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="size_fr"
                                                        class="form-control @error('size_fr') is-invalid @enderror"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                class="@if(!$product->product_image_1) d-none @endif img-fluid rounded mb-2"
                                                    width="100" height="100">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                class="@if(!$product->product_image_2) d-none @endif img-fluid rounded mb-2"
                                                    width="100" height="100">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                class="@if(!$product->product_image_3) d-none @endif img-fluid rounded mb-2"
                                                    width="100" height="100">
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        ...
                                                        <input type="checkbox" name="new"
                                                            class="form-check-input shadow-none" @checked(old('new') || $product->new)
                                                            value="1" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        ...
                                                        <input type="checkbox" name="hot_deal"
                                                            class="form-check-input shadow-none" @checked(old('hot_deal') || $product->hot_deal)
                                                            value="1" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        ...
                                                        <input type="checkbox" name="featured"
                                                            class="form-check-input shadow-none" @checked(old('featured') || $product->featured)
                                                            value="1" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check">
                                                        ...
                                                        <input type="radio" name="status"
                                                            class="form-check-input shadow-none" @checked(old('status') || $product->status)
                                                            value="1" />
                                                    </div>
                                                </div>
